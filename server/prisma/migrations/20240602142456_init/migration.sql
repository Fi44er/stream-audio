...
-- CreateTable
CREATE TABLE "room-likes" (
    "id" SERIAL NOT NULL,
    "userId" INTEGER NOT NULL,
    "roomId" TEXT NOT NULL,

    CONSTRAINT "room-likes_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "room-likes" ADD CONSTRAINT "room-likes_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "room-likes" ADD CONSTRAINT "room-likes_roomId_fkey" FOREIGN KEY ("roomId") REFERENCES "rooms"("id") ON DELETE CASCADE ON UPDATE CASCADE;
